       ...
       ======================== -->
        <div class="col-sm-9 no-padding">
            <div class="user-page-content">
               ...
               <!-- ** Page Title **  -->
                <div>
                    <h2 class="user-page-content__title">Pending Requests</h2>
                </div>
                        ...
                        <table class="table dataTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success sm-btn">Approve</a>
                                        <button class="btn btn-danger sm-btn show-canel-pop">Cancel</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bill-id" data-id="983">#983</td>
                                    <td>Ahmed Elattar</td>
                                    <td><span>$</span> 458</td>
                                    <td>Jan 15, 2018 14:39</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="bill-id" data-id="435">#435</td>
                                    <td>Ahmed Elattar</td>
                                    <td><span>$</span> 458</td>
                                    <td>Jan 15, 2018 14:39</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="bill-id" data-id="655">#655</td>
                                    <td>Ahmed Elattar</td>
                                    <td><span>$</span> 458</td>
                                    <td>Jan 15, 2018 14:39</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="bill-id" data-id="743">#743</td>
                                    <td>Ahmed Elattar</td>
                                    <td><span>$</span> 458</td>
                                    <td>Jan 15, 2018 14:39</td>
                                    <td>
