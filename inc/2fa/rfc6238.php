<?php
  // http://www.faqs.org/rfcs/rfc6238.html   
    ...
    public static function getBarCodeUrl($username, $domain, $secretkey, $issuer) {
      ...
      $url = $url."?chs=200x200&chld=M|0&cht=qr&chl=otpauth%3A%2F%2Ftotp%2F";
      $url = $url.$username . "BPT Crypo" . $domain . "%3Fsecret%3D" . $secretkey . '%26issuer%3D' . rawurlencode($issuer);
