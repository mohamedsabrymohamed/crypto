<?php 
    class log_table
    {
		...
		public function retrieve_all_login_hist()
		{
		...
		public function retrieve_login_by_user_ID($id)
		{
			...
			public function retrieve_login_by_user_ID_active($id)
		{
		...
		public function update_login_user($user_id)
		{
			$logout_date= DATE('Y-m-d H:i:s');
			
		   $query = "update ".$this->_table_name." 
					SET ACTIVE =0 , LOGOUT_TIMESTAMP = '".$logout_date."'
					WHERE  
		...
		public function update_login_user_by_session($session_id)
		{
			$logout_date= DATE('Y-m-d H:i:s');
		...
		public function update_login_user_by_userid($session_id,$cur_session_id)
		{
			$logout_date= DATE('Y-m-d H:i:s');
